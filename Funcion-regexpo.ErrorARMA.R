...
# coefficients:  Matriz con la tabla de parámetros estimados, sus errores estándar, estadístico T0 y valor P asociado. Tenga en cuenta que no hay una estimación conjunta de los parámetros
...
# forecast:      Objeto tipo ts con los pronósticos puntuales de la respuesta para h=nrow(newdata) periodos después del ajuste.
